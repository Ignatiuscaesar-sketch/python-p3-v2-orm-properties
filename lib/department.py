...
class Department:
    ...
    def __init__(self, name, location, id=None):
        self.id = id
        self._name = None  # Initialize with None to ensure setter is used
        self._location = None  # Initialize with None to ensure setter is used
        self.name = name  # Use the property setter
        self.location = location  # Use the property setter
    ...
    def save(self):
        ...
        Save the object in the local dictionary using table row's PK as dictionary key."""
        sql = """
